...
- Se detecta que las columnas 'delivery_time_hours' y 'expected_time_hours' se importaban incorrectamente como fechas. Solucionado a traves de Power Query forzando el tipo de columna a texto, extrayendo los últimos 4 caracteres y cambiando de nuevo el tipo de columna a número entero.
